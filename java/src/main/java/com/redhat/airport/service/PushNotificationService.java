...
public class PushNotificationService {
	...
	public void sendFlightNotification(@Observes int demoMode) {
		...
		case 3:
			...
			notificationType = "FLIGHT_ONTIME";
			break;
		default:
			message = null;
		...
		UnifiedMessage unifiedMessage = new UnifiedMessage.Builder().pushApplicationId("31ab23f8-e430-4956-adaa-b58ee6cf6c1a")
				.masterSecret("c0862d46-9cb0-4bdd-81d2-15e3f5c860eb").alert(message).attribute("NOTIFICATION_TYPE", notificationType).build();
